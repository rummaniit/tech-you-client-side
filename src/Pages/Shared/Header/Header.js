        ...
        <div className='md:p-8'>
            <nav className='md:flex justify-between items-center '>
                ...
                <div className='hidden md:flex justify-around items-center'>
                    ...
                    <p> <NavLink className='text-xl p-3' style={({ isActive }) =>
                        isActive ? activeStyle : undefined
                    } to='/courses'>Courses</NavLink></p>
                    <p> <NavLink className='text-xl p-3' style={({ isActive }) =>
                        isActive ? activeStyle : undefined
                    } to='/faq'>Faq</NavLink></p>
                    <p> <NavLink className='text-xl p-3' style={({ isActive }) =>
                        isActive ? activeStyle : undefined
                    } to='/blog'>Blog</NavLink></p>
                ...
                <p className='flex justify-start hamburger w-12 md:hidden'><svg xmlns="http://www.w3.org/2000/svg" onClick={() => setDisplay(!display)} fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
