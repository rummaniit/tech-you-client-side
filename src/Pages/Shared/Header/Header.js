    ...
    return (
        <div className='md:p-8'>
            <nav className='md:flex justify-between items-center '>
                ...
                <p className='flex justify-start hamburger w-12 md:hidden'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
